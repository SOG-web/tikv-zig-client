// PD gRPC implementation for GetRegionByID
...
pub fn getRegionByID(self: *client_mod.GrpcPDClient, region_id: u64, need_buckets: bool) Error!Region {
    ...
    // Build GetRegionByID request
    var req = pdpb.GetRegionByIDRequest{
    ...
    // Call PD.GetRegionByID
    const resp_bytes = client_wrapper.call("/pdpb.PD/GetRegionByID", req_bytes, .gzip, 5000) catch return Error.RpcError;
